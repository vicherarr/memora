...
WORKDIR /src
COPY ["Memora.csproj", "."]
RUN dotnet restore "./Memora.csproj"
COPY . .
WORKDIR "/src/."
RUN dotnet build "./Memora.csproj" -c $BUILD_CONFIGURATION -o /app/build

# Esta fase se usa para publicar el proyecto de servicio que se copiará en la fase final.
FROM build AS publish
ARG BUILD_CONFIGURATION=Release
RUN dotnet publish "./Memora.csproj" -c $BUILD_CONFIGURATION -o /app/publish /p:UseAppHost=false
